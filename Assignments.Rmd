...
#setwd(~/Documents/Github/Aishas-Website/)
```
...
```{r}
library(readr)
simulated_crime <- read_csv("~/Documents/GitHub/simulated-crime.csv")
View(simulated_crime)
```
```{r}
file.rename(simulated-crime.csv,dat)
```
